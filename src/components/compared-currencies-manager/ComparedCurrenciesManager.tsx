...
import { addCompared } from '../../features/currencies/currenciesSlice';
...
export default function ComparedCurrenciesManager() {
	...
	return (
		<Stack spacing={1}>
			...
			<ComparedCurrenciesList compared={compared} min={MIN_COMPARED_CURRENCIES} max={MAX_COMPARED_CURRENCIES} />
		</Stack>
	);
}
